...
<script src="${ctx}/js/manage/manage-user.js"></script>
...
<body>
  ...
  <div id="content">
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span12">
		 <form name="pageform" id="pageform"action="${ctx}/manage/member/user" method="post">
  ...
  <div id="deleteDialog" class="modal hide fade">
    <form class="form-horizontal" name="deleteDialogForm"
      ...
      action="${ctx}/manage/member/user/delete">
