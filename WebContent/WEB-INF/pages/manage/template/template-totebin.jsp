      ...
      <div class="row-fluid">
        <div class="span12">
          <table class="table table-bordered">
            <tbody>
              <tr height="36">
                <td rowspan="6" class="center title" style="width: 3%">货物资料</td>
                <td class="center title" style="width: 13%;">货物性质</td>
                <td colspan="3" style="width: 42%">${orderData.cargoNature.description}</td>
                <td class="center title" style="width: 14%;">开具发票</td>
                <td colspan="2" style="width: 28%">${orderData.askInvoice.description}</td>
              </tr>
              <tr height="36">
                <td rowspan="2" class="center title" style="width: 13%">规格</td>
                <td colspan="2" class="center title" style="width: 28%">20’标箱</td>
                <td colspan="2" class="center title" style="width: 28%">40’标箱</td>
                <td colspan="2" class="center title" style="width: 28%">45’标箱</td>
              </tr>
              <tr height="36">
                <td class="center title" style="width: 14%">吉</td>
                <td class="center title" style="width: 14%">重</td>
                <td class="center title" style="width: 14%">吉</td>
                <td class="center title" style="width: 14%">重</td>
                <td class="center title" style="width: 14%">吉</td>
                <td class="center title" style="width: 14%">重</td>
              ...
              <tr height="36">
                <td rowspan="1" class="center title" style="width: 13%">箱量</td>
                <td class="center" style="width: 14%"><c:if test="${orderData.arrTeu[0]>0}">${orderData.arrTeu[0]}个</c:if></td>
                <td class="center" style="width: 14%"><c:if test="${orderData.arrTeu[1]>0}">${orderData.arrTeu[1]}个</c:if></td>
                <td class="center" style="width: 14%"><c:if test="${orderData.arrTeu[2]>0}">${orderData.arrTeu[2]}个</c:if></td>
                <td class="center" style="width: 14%"><c:if test="${orderData.arrTeu[3]>0}">${orderData.arrTeu[3]}个</c:if></td>
                <td class="center" style="width: 14%"><c:if test="${orderData.arrTeu[4]>0}">${orderData.arrTeu[4]}个</c:if></td>
                <td class="center" style="width: 14%"><c:if test="${orderData.arrTeu[5]>0}">${orderData.arrTeu[5]}个</c:if></td>
              </tr>
              <tr height="36">
                <td rowspan="1" class="center title" style="width: 13%">运价</td>
                <td class="center" style="width: 14%"><c:if test="${orderData.arrPrice[0]>0}">${orderData.arrPrice[0]}元/个</c:if></td>
                <td class="center" style="width: 14%"><c:if test="${orderData.arrPrice[1]>0}">${orderData.arrPrice[1]}元/个</c:if></td>
                <td class="center" style="width: 14%"><c:if test="${orderData.arrPrice[2]>0}">${orderData.arrPrice[2]}元/个</c:if></td>
                <td class="center" style="width: 14%"><c:if test="${orderData.arrPrice[3]>0}">${orderData.arrPrice[3]}元/个</c:if></td>
                <td class="center" style="width: 14%"><c:if test="${orderData.arrPrice[4]>0}">${orderData.arrPrice[4]}元/个</c:if></td>
                <td class="center" style="width: 14%"><c:if test="${orderData.arrPrice[5]>0}">${orderData.arrPrice[5]}元/个</c:if></td>
              </tr>
              <tr height="36">
                <td rowspan="1" class="center title" style="width: 13%">货物细节说明</td>
                <td colspan="6" class="center" style="width: 84%">${orderData.cargoDesc}</td>
              </tr>
            </tbody>
          </table>
        </div>
