...
<body style="font-family: 'Arial Unicode MS'">
  <div id="container" style="margin: 0px auto">
    <div id="order-basic-info" style="margin-top: 5px;"
          ...
          <table class="table table-bordered">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <fmt:formatNumber var="fmtWeight" value="${orderData.weight}" pattern="#"/>
                  ${fmtWeight}吨
                </td>
                <td class="center title">载箱量</td>
                <td>
                  <fmt:formatNumber var="fmtContainerCount" value="${orderData.containerCount}" pattern="#"/>
                  ${fmtContainerCount}(TEU)
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div class="row-fluid">
        <div class="span12">
          <table class="table table-bordered">
            <tbody>
              <tr>
                <td rowspan="2" class="center title" style="width: 3%">装卸约定</td>
      ...
      <!-- 货物 -->
      <c:if test="${orderData.orderType.cargoType.cargoBigType=='container'}">
      <div class="row-fluid">
        <div class="span12">
          <table class="table table-bordered">
            <tbody>
              <tr height="36">
                ...
                <td colspan="2" class="center title" style="width: 28%">20英尺标箱</td>
                <td colspan="2" class="center title" style="width: 28%">40英尺标箱</td>
                <td colspan="2" class="center title" style="width: 28%">45英尺标箱</td>
              </tr>
              <tr height="36">
              ...
              <tr height="36">
                ...
                <c:forEach items="${orderData.mapCargoNames}" var="cargoName">
                <fmt:formatNumber var="tonTeu" value="${orderData.mapTonTeus[cargoName.key]}" pattern="#"/>
                <td class="center" style="width: 14%"><c:if test="${tonTeu > 0}">${tonTeu}个</c:if></td>
                </c:forEach>
              </tr>
              <tr height="36">
                ...
                <c:forEach items="${orderData.mapCargoNames}" var="cargoName">
                <fmt:formatNumber var="tonTeu" value="${orderData.mapTonTeus[cargoName.key]}" pattern="#"/>
                <fmt:formatNumber var="price" value="${orderData.mapPrices[cargoName.key]}" pattern="#.##"/>
                <td class="center" style="width: 14%"><c:if test="${tonTeu > 0}">${price}元/个</c:if></td>
                </c:forEach>
              </tr>
            </tbody>
          </table>
      ...
      <div class="row-fluid">
        <div class="span12">
          <table class="table table-bordered">
            <tbody>
              <tr height="36">
                <td rowspan="2" class="center title" style="width: 3%">货物资料</td>
                <td class="center title" style="width: 19%;">货类</td>
                <td style="width: 28%">
                  ${orderData.cargoType.description}
                </td>
                <td class="center title" style="width: 19%;">货名</td>
                <td style="width: 31%">
                  ${orderData.cargoNames}
                </td>
              </tr>
              <tr height="36">
                <td class="center title">货量</td>
                <td>
                  <fmt:formatNumber var="fmtTonTeus" value="${orderData.tonTeus}" pattern="#.##"/>
                  ${fmtTonTeus}吨
                </td>
                <td class="center title">运价</td>
                <td>
                  <fmt:formatNumber var="fmtPrices" value="${orderData.prices}" pattern="#.##"/>
                  ${fmtPrices}元/吨
                </td>
              </tr>
            </tbody>
      ...
      <div class="row-fluid">
        <div class="span12">
          <table class="table table-bordered">
            <tbody>
              <tr>
                <td rowspan="2" class="center title" style="width: 3%">支付约定</td>
                <td class="center title" style="width: 19%;">总运费</td>
                <td style="width: 28%;">
                  <fmt:formatNumber var="fmtTransFee" value="${orderData.transFee}" pattern="#.##"/>
                  ${fmtTransFee}元
                </td>
                <td class="center title" style="width: 19%;">滞期费率</td>
                <td style="width: 31%;">
                  <fmt:formatNumber var="fmtDemurrage" value="${orderData.demurrage}" pattern="#.##"/>
                  ${fmtDemurrage}元/船.天
                </td>
              </tr>
              <tr>
                <td class="center title">付款分期</td>
                <td>${orderData.paySteps}期</td>
