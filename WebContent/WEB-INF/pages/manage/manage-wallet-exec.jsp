...
<script src="${ctx}/js/manage/manage-wallet-exec.js"></script>
...
<body>
  ...
  <div id="content">
    <div id="breadcrumb">
      ...
      </a> <a href="#" style="font-size: 12px;" class="current">退款处理</a>
    </div>
    <div class="container-fluid">
      <div class="row-fluid">
        <div class="span12">
		 <form name="pageform" id="pageform"action="${ctx}/manage/wallet/walletExec" method="post">
            ...
            <div class="widget-title">
	          ...
	          <div class="control-group styleCenter" style="float:left;width:200px;margin-left:10px;margin-top:3px;">
                <div style="margin-left:10px;" class="controls input-append date dateEndDate" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2">
            	  <input size="16" type="text" name="endDate" id="endDate"  style="width:120px;margin-bottom:0px;" value="${startDate}" placeholder="终止日期!"/>            	
                    ...
                    <tr class="gradeX">
                      ...
                      <td>
						...
						<a class="btn btn-primary btnPayment" idVal="${wallet.id}" 
                       		    data-toggle="modal">
                          <i class="icon-list-alt icon-white"></i> 确认付款
                        </a>
                        <a class="btn btn-primary btnRefund" idVal="${wallet.id}" 
                       		    data-toggle="modal">
                          <i class="icon-list-alt icon-white"></i> 退款
                        </a>
						</c:if>
                      </td>
                    </tr>
