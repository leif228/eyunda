        ...
        <div class="content">
          ...
          <div class="content-body">
            ...
            <div class="row-fluid">
              <!--span-->
              <div class="span12">
				<form name="pageform" id="pageform" action="${ctx}/portal/home/cargoHome" method="post">
                <div class="box corner-all">
                  <div class="box-header grd-white color-silver-dark corner-top">
                    <span style="font-size: 16px;">货物列表</span>
                    <div style="margin-top: -25px; margin-left: 80px; height: 25px;">
					  <select id="changeCargoType" name="cargoType" style="width: 160px;">
					    <option value="" selected>货类......</option>
                        <c:forEach var="cargoBigTypeCode" items="${cargoTypeCodes}">
	                      <optgroup label="${cargoBigTypeCode.description}">
                            <c:choose>
	                          <c:when test="${cargoBigTypeCode.toString() == 'container'}">
	                              <c:choose>
                      ...
                      <select id="changeCargoWeight" name="cargoWeight" style="width: 150px;">
                        <option value="" selected>货量......</option>
                        <c:choose>
                      ...
                      <select id="changeUpPortCity" name="upPort" style="width: 150px;">
                        <option value="" selected>装货港......</option>
                       ...
                       <select id="changeDownPortCity" name="downPort" style="width: 160px;">
                        <option value="" selected>卸货港......</option>
                        <c:forEach var="bigAreaCode" items="${bigAreaCodes}">
                          <optgroup label="${bigAreaCode.description}">
                            <c:forEach var="portCity" items="${bigAreaCode.portCities}">
                              <c:choose>
                                <c:when test="${portCity == downPort}">
                                  <option value="${portCity} " selected>${portCity.description}</option>
                                </c:when>
                                <c:otherwise>
                                  <option value="${portCity}">${portCity.description}</option>
                      ...
                      <a class="btn btn-primary searchCargo" style="margin-bottom: 8px">
                  ...
                  <div class="box-body" style="padding: 0px">
                    <table class="table table-bordered data-table table-striped" 
                      ...
                      <tbody>
                        <c:forEach  var="cargoData" items="${cargoPageData.result}">
                      	  <tr>
                  ...
                  <jsp:include page="./pagerHomeCargo.jsp"></jsp:include>
                </div>
                </form>
              </div>
            </div>
