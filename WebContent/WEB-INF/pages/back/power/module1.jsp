...
<head>
    ...
    <link href="https://cdn.bootcss.com/bootstrap/3.3.6/css/bootstrap.min.css" rel="stylesheet">
    <link href="${ctx}/hyqback/css/style.min.css?v=4.1.0" rel="stylesheet">
        ...
        <div class="col-sm-4">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <p>
                        创建自定义的H+模态窗口可通过添加<code>.inmodal</code>类来实现。 </p>
...
<script src="${ctx}/hyqback/js/content.min.js?v=1.0.0"></script>
