...
<script type="text/javascript">
	...
	function Validate(value) {
		var URL = _rootPath+"/space/order/myOrder/downloadPdf?id=${orderId}";
				...
				<div class="rightCont">
					<div class="contentBig">
						<div class="btnContainers">
							...
							<form action="${ctx}/space/order/show?id=${orderId}" name="Form2" method="post" target="printFrame" style="margin: 0px;">
								<div style="float:left;">
									<input type="button" class="btn" name="pConfirm" id="pConfirmks" value="PDF下载" onclick="Validate('PDF')">
								</div>
							</form>
						...
						<iframe align="top" frameborder="0" height="780" name="printFrame" id="printFrame" scrolling="auto" width="700" src="" onLoad="iFrameHeight();"></iframe>
					</div>
				</div>
			</div>
		</div>
