			...
			<nav id="site-nav" class="main-nav">
					...
					<div class="">
						<ul id="" class="down-menu nav-menu">
							<li class="menu-item"><a href="${ctx }/portal/home/cabinHome/?waresType=nmjzx&cargoType=container20e" style="<c:if test='${waresType eq "nmjzx"}'>color:red;font-weight:bold</c:if>" ><i
									class="fa" style="color:#000;font-weight:bold;font-size:16px;">集装箱：</i><i class="fa-credit-card fa"></i>内贸集装箱</a></li>
							<li class="menu-item"><a href="${ctx }/portal/home/cabinHome/?waresType=gaxjzx&cargoType=container20e" style="<c:if test='${waresType eq "gaxjzx" }'>color:red;font-weight:bold</c:if>" ><i class="fa-dashboard fa"></i>港澳集装箱</a></li>
							<li class="menu-item"><a href="${ctx }/portal/home/cabinHome/?waresType=nmszh&cargoType=coal" style="<c:if test='${waresType eq "nmszh"  && cargoType == "coal"}'>color:red;font-weight:bold</c:if>" ><i
									class="fa" style="color:#000;font-weight:bold;font-size:16px;">散杂货：</i><i class="fa-credit-card fa"></i>煤炭</a></li>
							<li class="menu-item"><a href="${ctx }/portal/home/cabinHome/?waresType=nmszh&cargoType=steel"style="<c:if test='${waresType eq "nmszh"  && cargoType == "steel"}'>color:red;font-weight:bold</c:if>" ><i
									class="fa-camera fa"></i>钢铁</a></li>
							<li class="menu-item"><a href="${ctx }/portal/home/cabinHome/?waresType=nmszh&cargoType=tile" style="<c:if test='${waresType eq "nmszh"  && cargoType == "tile"}'>color:red;font-weight:bold</c:if>" ><i
									class="fa-dashboard fa"></i>建材</a></li>
							<li class="menu-item"><a href="${ctx }/portal/home/cabinHome/?waresType=nmszh&cargoType=cement" style="<c:if test='${waresType eq "nmszh"  && cargoType == "cement"}'>color:red;font-weight:bold</c:if>" ><i
