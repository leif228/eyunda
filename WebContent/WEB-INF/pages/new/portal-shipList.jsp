			                  ...
			                  <a href="${ctx}/portal/home/shipInfo?shipId=${shipData.id}" class="row-fluid">
			                    ...
			                    <div class="one-line-info span10 fa-pull-right" style="width: 87%;margin-right: -80px;padding-left: 10px;padding-top:5px;">
			                      <div class="one-line-title row-fluid">
			                        <div class="span6 adj-height-40" style="margin-bottom: 5px;line-height:110%;">${shipData.shipName}</div>
			                        <div class="span6 to-right adj-height-40" style="margin-bottom: 5px;">发布时间：${shipData.shipCabinData.createTime}</div>
			                      </div>
			                      <div>
			                        <p style="line-height:20px;">${shipData.cabinDesc}</p>
			                      </div>
			                    </div>
			                  </a>
			                </div>
