...
<body>
  ...
  <nav class="breadcrumb"
    ...
    <a class="crumbs" title="船盘" href="${ctx}/portal/home/cabinHome">船盘</a> <i
      class="fa fa-angle-right"></i> ${myShipData.shipName} - ${cabinData.description}
  </nav>
  <!-- section content -->
      ...
      <div class="line-one">
        <div class="cat-box">
          ...
          <div class="row-fluid cat-site">
            ...
            <div class="span10" >
              <div id="tabs">
                <div class="tab-info" style="border-top:1px solid #ddd">
