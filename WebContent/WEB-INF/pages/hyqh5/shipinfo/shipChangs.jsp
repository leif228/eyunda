  ...
  <header class="weui-flex " style="text-align: center;">
    ...
    <div class="bd">
      ...
      <form method="post" id="shipShareForm" action="">
        ...
        <div class="weui-cells weui-cells_form">
          <div class="weui-cell">
            ...
            <div class="weui-cell__bd">
              <input class="weui-input login_name" type="text" name="loginName" value="" placeholder="请选择接收人" readonly="readonly">
            </div>    
            <div class="weui-cell_ft"><a href="javascript:;" class="weui-btn weui-btn_mini weui-btn_plain-primary select-user">选择</a></div>      	
          </div>

          <div class="weui-cells__title">证书转移</div>
        ...
        <div class="weui-cells__tips">说明：请选择指定用户，转移船舶下所有证书所有权给指定用户。</div>
