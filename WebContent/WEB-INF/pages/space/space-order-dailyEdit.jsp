...
<script src="${ctx}/js/space/space-order-dailyEdit.js"></script>
              ...
              <div class="tab-pane active" id="order-edit2">
                <form class="form-horizontal" name="frmSaveAll" id="frmSaveAll"
                  ...
                  <input type="hidden" id="orderType" name="orderType"
                    value="${orderCommonData.orderType}" />
                  <fieldset>
                    ...
                    <div class="orderCargoInfo">
                      <div class="row-fluid">
                        ...
                        <div class="span4">
                          <div class="control-group">
                            <div style="text-align: center; background-color: #eee;">承租人：</div>
                            <div>
                      ...
                      <div class="row-fluid">
                        <div class="span6">
                          <div id="cargoBulkOrDanger">
                            <div class="control-group specificaOrCargoName">
                              ...
                              <div class="controls" id="containerCount">
                                重箱:${orderCommonData.shipData.fullContainer}TEU,半重箱:${orderCommonData.shipData.halfContainer}TEU,吉箱:${orderCommonData.shipData.spaceContainer}TEU
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="span6">
                          <div class="control-group tonOrBox">
                            ...
                            <div class="controls" id="weight">
                              载重A级:${orderCommonData.shipData.aTons}吨,载重A级:${orderCommonData.shipData.bTons}吨
                            </div>
                          </div>
                        </div>
                      </div>
                            ...
                            <div class="controls">
                              <div class="input-append date" data-form="datepicker"
                                ...
                                <input id="startDate" name="startDate" class="grd-white"
                                  ...
                                  size="10" type="text"
                                  value="${orderCommonData.startDate}"
                      ...
                      <div class="row-fluid">
                        <div class="span6">
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <select id="rcvPortNo" name="rcvPortNo"
                                style="width: 160px;">
                                <c:forEach var="upDownPortData"
                                  items="${upDownPortDatas}">
                                  <c:if
                                    test="${orderCommonData.rcvPortNo == upDownPortData.startPortNo}">
                                    <option value="${upDownPortData.startPortNo}" selected>${upDownPortData.startPortData.fullName}</option>
                                  </c:if>
                                  <c:if
                                    test="${orderCommonData.rcvPortNo != upDownPortData.startPortNo}">
                                    <option value="${upDownPortData.startPortNo}">${upDownPortData.startPortData.fullName}</option>
                                  </c:if>
                                </c:forEach>
                              </select>
                            </div>
                        ...
                        <div class="span6">
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <select id="retPortNo" name="retPortNo"
                                style="width: 160px;">
                                <c:forEach var="upDownPortData"
                                  items="${upDownPortDatas}">
                                  <c:if
                                    test="${orderCommonData.retPortNo == upDownPortData.startPortNo}">
                                    <option value="${upDownPortData.startPortNo}" selected>${upDownPortData.startPortData.fullName}</option>
                                  </c:if>
                                  <c:if
                                    test="${orderCommonData.retPortNo != upDownPortData.startPortNo}">
                      ...
                      <div class="row-fluid">
                        <div class="span6">
                          <div class="control-group">
                            <label class="control-label">租金率：</label>
                            <div class="controls">
                              <fmt:formatNumber var="fmtPrice"
                                value="${orderCommonData.price}" pattern="#.##" />
                              <input placeholder="请输入有效数字" type="text" <c:if test="${orderCommonData.handlerId!=userData.id}">readonly="readonly"</c:if>
                                class="data-empty" name="price" id="price"
                                value="${fmtPrice}" style="width: 150px;" />&nbsp;&nbsp;元/天
                            </div>
                          </div>
                        </div>
                        <div class="span6">
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <fmt:formatNumber var="fmtDays"
                                value="${orderCommonData.days}" pattern="#0" />
                              <input placeholder="请输入有效数字" type="text"
                                class="data-empty" name="days" id="days"
                                value="${fmtDays}" style="width: 150px;" />&nbsp;&nbsp;天
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row-fluid">
                        <div class="span6">
                          <div class="control-group">
                            <label class="control-label">总租金：</label>
                            <div class="controls">
                        ...
                        <div class="span6">
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <fmt:formatNumber var="fmtOilPrice"
                                value="${orderCommonData.oilPrice}" pattern="#.##" />
                              <input placeholder="请输入有效数字" type="text" <c:if test="${orderCommonData.handlerId!=userData.id}">readonly="readonly"</c:if>
                                class="data-empty" name="oilPrice" id="oilPrice"
                                value="${fmtOilPrice}" style="width: 150px;" />&nbsp;&nbsp;元/公里
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="dlgUserSelector-title">查找用户</h4>
          </div>
          <div class="modal-body">
            <fieldset>
              <div class="control-group pdleft">
