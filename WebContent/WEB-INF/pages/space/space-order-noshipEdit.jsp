...
<script src="${ctx}/js/space/space-order-noshipEdit.js"></script>
                    ...
                    <div class="orderCargoInfo">
                      <div class="row-fluid">
                        ...
                        <div class="span7">
                          ...
                          <div class="control-group">
                            <label class="control-label" for="startDate">运输开始日期：</label>
                            <div class="controls">
                          ...
                          <div class="control-group">
                            <label class="control-label" for="endDate">运输结束日期：</label>
                            <div class="controls">
                              <div class="input-append date" data-form="datepicker"
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <select id="cargoType" name="cargoType"
                                style="width: 220px;">
                                <c:forEach var="bulkTypeCode" items="${bulkTypeCodes}">
                                  <c:if test="${bulkTypeCode == orderCommonData.cargoType}">
                                    <option value="${bulkTypeCode}" selected>${bulkTypeCode.description}</option>
                                  </c:if>
                                  <c:if test="${bulkTypeCode != orderCommonData.cargoType}">
                                    <option value="${bulkTypeCode}">${bulkTypeCode.description}</option>
                                  </c:if>
                                 </c:forEach>
                              </select>
                            </div>
                          ...
                          <div class="control-group">
                            <label class="control-label">运费计算说明：</label>
                            <div class="controls">
                              <textarea placeholder="运费计算说明" rows="3"
                               id="calcDesc" name="calcDesc">${orderCommonData.calcDesc}</textarea>
                            </div>
                          </div>
