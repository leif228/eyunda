...
<body>
  ...
  <div class="span10">
    ...
    <div style="float: left; margin-top: 0px;">
      ...
      <a style="margin-top: -1px; font-size: 16px; color: red" title="">可用余额：${empty totalBalance ? "0.00" : totalBalance} 元</a>
      &nbsp;&nbsp;
      <img alt="" style="height: 16px; margin-top: -2px;" src="${ctx}/img/money/money.jpg">
      <a style="margin-top: -1px; font-size: 16px; color: red" title="">可提现余额：${empty totalTranOutAmount ? "0.00" : totalTranOutAmount} 元</a>
    </div>

	<div style="float: left; margin-top: 0px; margin-left: 20px;">
      <a class="btn btn-primary" href="${ctx}/space/wallet/myWallet" style="margin-top: -1px;" title="返回">返回</a>
    </div>
      ...
      <div class="span10">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane active" id="wallet">
              <form novalidate="novalidate" method="get" id="pageform" action="${ctx}/space/wallet/myWallet/getUserSettles">
                    ...
                    <table class="table table-bordered data-table table-striped">
                      <thead>
                       <tr>
	                    ...
	                    <th style="width: 20%">增减</th>
	                    <th style="width: 20%">交易描述</th>
	                    <th style="width: 20%">交易金额(元)</th>
	                    <th style="width: 20%">可用余额(元)</th>
	                  </tr>
                      </thead>
                      <tbody>
                        <c:forEach items="${pageData.result}" var="settleData">
                          <tr>
                            <td>${settleData.payDate}&nbsp;${settleData.payTime}</td>
	                      	<td>
                              <c:if test="${settleData.money > 0}">
                              <img src="${ctx}/img/bank2/add.png" style="width: 40px; height: 40px;" alt="" class="thumbnail" />
                              </c:if>
                              <c:if test="${settleData.money < 0}">
                              <img src="${ctx}/img/bank2/minus.png" style="width: 40px; height: 40px;" alt="" class="thumbnail" />
                              </c:if>
	                      	</td>
