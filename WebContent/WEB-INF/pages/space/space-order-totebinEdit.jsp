...
<script src="${ctx}/js/space/space-order-totebinEdit.js"></script>
                        ...
                        <div class="span7">
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <span class="endPortCityName"> <select
                                id="endPortCity" name="endPortCity"
                                style="width: 160px;">
                                  <c:forEach var="bigArea" items="${bigAreas}">
                                    <optgroup label="${bigArea.description}">
                                      <c:forEach var="portCity"
                          ...
                          <div id="cargoContainer">
                            ...
                            <div class="control-group specificaOrCargoName">
                              ...
                              <div class="controls">
                                <input type="text" style="width: 40px;"
                                  name="cargoName1" readonly="true" id="cargoName1"
                                  value="${orderCommonData.arrCargoName[0]}" /> 
                                <input type="text" style="width: 40px;" 
                                  name="cargoName2" readonly="true" id="cargoName2"
                                  value="${orderCommonData.arrCargoName[1]}" /> 
                                <input type="text" style="width: 40px;" 
                                  name="cargoName3" readonly="true" id="cargoName3"
                                  value="${orderCommonData.arrCargoName[2]}" /> 
                                <input type="text" style="width: 40px;" 
                                  name="cargoName4" readonly="true" id="cargoName4"
                                  value="${orderCommonData.arrCargoName[3]}" /> 
                                <input type="text" style="width: 40px;" 
                                  name="cargoName5" readonly="true" id="cargoName5"
                                  value="${orderCommonData.arrCargoName[4]}" /> 
                                <input type="text" style="width: 40px;" 
                                  name="cargoName6" readonly="true" id="cargoName6"
                                  value="${orderCommonData.arrCargoName[5]}" />
                              </div>
                            </div>
                            ...
                            <div class="control-group tonOrBox">
                              ...
                              <div class="controls">
                                <input type="text" placeholder="请输入数字"
                                  style="width: 40px;" id="tonTeu1" name="tonTeu1"
                                  value="${orderCommonData.arrTeu[0]}" /> <input
                                  type="text" placeholder="请输入数字" style="width: 40px;"
                                  id="tonTeu2" name="tonTeu2"
                                  value="${orderCommonData.arrTeu[1]}" /> <input
                                  type="text" placeholder="请输入数字" style="width: 40px;"
                                  id="tonTeu3" name="tonTeu3"
                                  value="${orderCommonData.arrTeu[2]}" /> <input
                                  type="text" placeholder="请输入数字" style="width: 40px;"
                                  id="tonTeu4" name="tonTeu4"
                                  value="${orderCommonData.arrTeu[3]}" /> <input
                                  type="text" placeholder="请输入数字" style="width: 40px;"
                                  id="tonTeu5" name="tonTeu5"
                                  value="${orderCommonData.arrTeu[4]}" /> <input
                                  type="text" placeholder="请输入数字" style="width: 40px;"
                                  id="tonTeu6" name="tonTeu6"
                                  value="${orderCommonData.arrTeu[5]}" />
                              </div>
                            </div>
                            ...
                            <div class="control-group unitPriceTonOrBox">
                              ...
                              <div class="controls">
                                <input type="text" placeholder="请输入数字"
                                  style="width: 40px;" id="price1" name="price1"
                                  value="${orderCommonData.arrPrice[0]}" /> <input
                                  type="text" placeholder="请输入数字" style="width: 40px;"
                                  id="price2" name="price2"
                                  value="${orderCommonData.arrPrice[1]}" /> <input
                                  type="text" placeholder="请输入数字" style="width: 40px;"
                                  id="price3" name="price3"
                                  value="${orderCommonData.arrPrice[2]}" /> <input
                                  type="text" placeholder="请输入数字" style="width: 40px;"
                                  id="price4" name="price4"
                                  value="${orderCommonData.arrPrice[3]}" /> <input
                                  type="text" placeholder="请输入数字" style="width: 40px;"
                                  id="price5" name="price5"
                                  value="${orderCommonData.arrPrice[4]}" /> <input
                                  type="text" placeholder="请输入数字" style="width: 40px;"
                                  id="price6" name="price6"
                                  value="${orderCommonData.arrPrice[5]}" />
                              </div>
                            </div>
                            <!-- 规格属性字符串 -->
                            <input type="hidden" id="cargoNames" name="cargoNames" value="">
                            <!-- 箱量(个)属性字符串 -->
                            <input type="hidden" id="teus" name="teus" value="">
                            <!-- 运价(元/个)属性字符串 -->
