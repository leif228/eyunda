...
<script src="${ctx}/js/space/space-walletPayPwd.js"></script>
...
<body style="margin:0px auto;">
  ...
  <div class="box" style="margin:20px auto">
    ...
    <h1 class="page-title">
      <i class="icon-star icon-white"></i> 支付验证
    </h1>
    <div>
      <div>
        <div class="widget">
					...
					<!-- <div class="control-group">
			          ...
			          <div class="controls" >
			            <input type="text" class="input-medium" id="messageCode" name="messageCode"
			              ...
			              <div>
			              	<button disabled="disabled" class="btn btn-primary btnTimeOut" style="margin-top: 5px">120秒后需重新获取验证码</button >
			              </div>	
			          </div>
			        </div> -->
			        
                    <div class="form-actions" style="text-align:center">
		              <a href="javascript:window.close();" class="btn btn-warning" data-dismiss="modal">
		                <i class="icon icon-off"></i> 关闭
		              </a>
		              <a class="btn btn-primary btnPay">
