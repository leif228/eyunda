...
<script src="${ctx}/js/space/space-order-bulkEdit.js"></script>
                      ...
                      <div class="row-fluid">
                        ...
                        <div class="span7">
                          ...
                          <div class="control-group">
                            ...
                            <div class="controls">
                              <select id="bulkType" name="bulkType"
                                style="width: 220px;">
                                <c:forEach var="bulkTypeCode" items="${bulkTypeCodes}">
                                  <c:if test="${bulkTypeCode == orderCommonData.bulkType}">
