...
<script src="${ctx}/js/space/space-cabin-voyage-edit.js"></script>
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="order-edit2">
            <form class="form-horizontal" name="frmSaveAll" id="frmSaveAll" method="post" action="" novalidate="novalidate">
              ...
              <input type="hidden" id="prices" name="prices" value="${cabinData.prices}" />
              ...
              <fieldset>
                  ...
                  <div class="span6">
                    <div class="control-group">
                      ...
                      <div class="controls">
                        ...
                        <input type="text" style="width: 150px;" name="demurrage" value="${fmtDemurrage}">&nbsp;&nbsp;元/船.天
                      </div>
                    </div>
                  </div>
                  <div class="span6">
                ...
                <div class="row-fluid">
                  <div class="span6">
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <fmt:formatNumber var="fmtContainerCount" value="${cabinData.containerCount}" pattern="#"/>
                        <input type="text" style="width: 150px;" id="containerCount" name="containerCount" value="${fmtContainerCount}">&nbsp;&nbsp;TEU
                      </div>
                    </div>
                  </div>
                  <div class="span6">
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <div class="input-append date form_datetimeStart" data-form="datepicker"
                ...
                <div class="row-fluid">
                  <div class="span12">
                    ...
                    <div class="control-group">
                      <label class="control-label" for="remark">航线报价：</label>
                      <div class="controls">
                        <div style="color: #ff0000;">说明：运营航线选中，非运营航线取消选中即可。</div>
                        <div>
                          <table class="table table-bordered">
                            <thead>
			                  <tr>
			                    <th rowspan="2" style="width: 20%; text-align: center;">
			                      <input type="checkbox" id="allSailLine" value="" />
			                      航线
			                    </th>
			                    <th rowspan="2" style="width: 10%; text-align: center;">航程(公里)</th>
			                    <th rowspan="2" style="width: 10%; text-align: center;">载重量(吨)</th>
			                    <th colspan="6" style="width: 60%; text-align: center;">报价(元/个)</th>
			                  </tr>
			                  <tr>
			                    <c:forEach items="${containerCodes}" var="containerCode">
			                    <th style="width: 10%;">${containerCode.shortName}</th>
			                    </c:forEach>
			                  </tr>
			                </thead>
			                <tbody>
			                  ...
			                  <tr>
			                    <td>
			                      ...
			                      <input type="checkbox" name="gotoThisLine-${sailLineData.startPortNo}-${sailLineData.endPortNo}" value="1" checked="checked" />
			                      </c:if>
			                      <c:if test="${!sailLineData.gotoThisLine}">
			                      <input type="checkbox" name="gotoThisLine-${sailLineData.startPortNo}-${sailLineData.endPortNo}" value="1" />
			                      </c:if>
			                      ${sailLineData.startPortData.fullName} - ${sailLineData.endPortData.fullName}
			                    </td>
			                    <td style="text-align: right;">
			                      <fmt:formatNumber var="fmtDistance" value="${sailLineData.distance}" pattern="#"/>
			                      ${fmtDistance}
			                    </td>
			                    <td style="text-align: center;">
			                      <fmt:formatNumber var="fmtWeight" value="${sailLineData.weight}" pattern="#"/>
			                      <input type="text" class="weight" style="width: 40px;" name="weight-${sailLineData.startPortNo}-${sailLineData.endPortNo}" value="${fmtWeight}">
			                    </td>
			                    <c:forEach items="${sailLineData.mapPrices}" var="map">
			                    <td style="text-align: center;">
			                      <fmt:formatNumber var="mapValue" value="${map.value}" pattern="#.##"/>
			                      <input type="text" style="width: 40px;" name="price-${sailLineData.startPortNo}-${sailLineData.endPortNo}-${map.key}" value="${mapValue}">
			                    </td>
			                    </c:forEach>
			                  </tr>
			                  </c:forEach>
                      ...
                      <div class="controls">
                        ...
                        <div>
                          <table class="table table-bordered">
                            <thead>
			                  <tr>
			                    <th style="width: 45%;">航线</th>
			                    <th style="width: 15%;">航程(公里)</th>
			                    <th style="width: 15%;">载重量(吨)</th>
			                    <th style="width: 25%;">报价(元/吨)</th>
			                  </tr>
			                </thead>
			                <tbody>
			                  <c:forEach items="${cabinData.sailLineDatas}" var="sailLineData">
			                  <tr>
			                    ...
			                    <td>
			                      <fmt:formatNumber var="fmtWeight" value="${sailLineData.weight}" pattern="#"/>
			                      <input type="text" style="width: 50px;" name="weight-${sailLineData.startPortNo}-${sailLineData.endPortNo}" value="${fmtWeight}">
			                    </td>
			                    <c:forEach items="${sailLineData.mapPrices}" var="map">
			                    <td>
			                      <fmt:formatNumber var="mapValue" value="${map.value}" pattern="#.##"/>
			                      <input type="text" style="width: 50px;" name="price-${sailLineData.startPortNo}-${sailLineData.endPortNo}-${map.key}" value="${mapValue}">
			                    </td>
			                    </c:forEach>
			                  </tr>
			                  </c:forEach>
