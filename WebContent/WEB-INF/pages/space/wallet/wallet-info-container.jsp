...
<script type="text/javascript">
	...
	function pdfDownload(type) {
		var URL = _rootPath+'/space/wallet/downloadPdf?settleType=${settleType}&id=${walletId}';
			...
			<div class="mainCont">
				<div class="rightCont">
					<div class="contentBig">
						...
						<iframe align="top" frameborder="0" height="780" name="printFrame" id="printFrame" scrolling="auto" width="700" src="${ctx}/space/wallet/show?settleType=${settleType}&id=${walletId}" onLoad="iFrameHeight();"></iframe>
					</div>
				</div>
			</div>
		</div>
