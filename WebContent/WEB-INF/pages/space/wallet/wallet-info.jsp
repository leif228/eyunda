        ...
        <div class="span12">
         <table class="table table-bordered">
            <tbody>
              ...
              <tr><td rowspan="4">付款方</td><td>帐号</td><td>*${walletData.bankCardNo4}</td><td rowspan="4">收款方</td><td>帐号</td><td>${walletData.rcvCardNo}</td></tr>
              <tr><td>户名</td><td>${walletData.sndAccountName}</td><td>户名</td><td>${walletData.rcvAccountName}</td></tr>
              <tr><td>开户行</td><td>${walletData.plantBankName}</td><td>开户行</td><td>平安银行</td></tr>
              <tr><td>帐户性质</td><td>银行帐户</td><td>帐户性质</td><td>平安见证宝</td></tr>
              ...
              <tr><td>支付编号</td><td colspan="2">${walletData.paymentNo}</td><td>交易时间</td><td colspan="2">${walletData.gmtPayment}</td></tr>
              <tr><td rowspan="4">付款方</td><td>帐号</td><td>${walletData.sndCardNo}</td><td rowspan="4">收款方</td><td>帐号</td><td>*${walletData.bankCardNo4}</td></tr>
              <tr><td>户名</td><td>${walletData.sndAccountName}</td><td>户名</td><td>${walletData.rcvAccountName}</td></tr>
              <tr><td>开户行</td><td>平安银行</td><td>开户行</td><td>${walletData.plantBankName}</td></tr>
              <tr><td>帐户性质</td><td>平安见证宝</td><td>帐户性质</td><td>银行帐户</td></tr>
              <tr><td rowspan="2">金额</td><td>小写</td><td>￥${walletData.totalFee}</td><td>手续费</td><td colspan="2">￥${walletData.handFee}</td></tr>
              <tr><td>合计</td><td>￥${walletData.totalFee + walletData.handFee}</td><td>合计(大写)</td><td colspan="2">${walletData.handFeeChinese}</td></tr>
              <tr><td>用途</td><td colspan="5">${walletData.settleStyle.description}</td></tr>
              </c:if>
              ...
              <tr><td>帐户性质</td><td>平安见证宝</td><td>帐户性质</td><td>平安见证宝</td></tr>
