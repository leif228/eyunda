...
<body>
	<div id="main">
		...
		<div class="container icon_row">
			<div>
				<a href="${ctx}/phone/eyundaV3.0_mobile.doc"
					class="app_btn green_btn"><img
					src="${ctx}/img/wx/doc.png"><br>eyunda</a>
			</div>
			<!-- 
			<div>
				<a href="javascript:void(0);" onclick="javascript:iosInstall();"
					class="app_btn orange_btn"><img
					src="%E9%BE%99%E6%B1%9F%E5%A5%B3%E6%80%A7APP%E4%B8%8B%E8%BD%BD_files/ios_icon.png"><br>苹果</a>
			</div> 
			<div>
				<a href="http://a.hljwomen.org/app/webapp.html"
					class="app_btn blue_btn"><img
					src="%E9%BE%99%E6%B1%9F%E5%A5%B3%E6%80%A7APP%E4%B8%8B%E8%BD%BD_files/webapp-icon.png"><br>手机网页</a>
			</div>
			-->
		</div>
