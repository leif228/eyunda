var BMapLib = window.BMapLib = BMapLib || {}; (function() {
    ...
    a.object.extend(c.prototype, {
        _addMarker: function(f) {
    		...
    		var marker = new BMap.Marker(this._path[0],{icon: myIcon});
    		this._map.addOverlay(marker);    //���ӵ�
    		var label = new BMap.Label(_shipName,{offset:new BMap.Size(35,-30)});
        ...
        _moveNext: function(e) {
            ...
            if (e < this._path.length - 1) {
            	setTimeout(function(){
            		...
            		if(_monitorSet == "shipmanagerplant"){
            			showImage(e);
            		}
        ...
        _moveNextOne: function(e) {
            var f = this;
            if (e < this._path.length - 1) {
                f._moveOne(f._path[e], f._path[e + 1], f._tween.linear)
            }
        },
	...
	function showImage(index){
		$.ajax({
			method : "GET",
			data : {mmsi: _mmsi, posTime : _points[index][2], cameraNo : 01},
			url : _rootPath+"/space/monitor/getShipImage",
			datatype : "json",
