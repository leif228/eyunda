	     ...
	     success : function(data) {
	       ...
	       if (returnCode == "Failure") {
	         ...
	         return false;
	    	   ...
	    	   alert(message);
	    	   window.location.href = _rootPath+"/portal/home/searchRelCargo?pageNo="+pageNo+"&keyWords="+inputSearch+"&searchRlsCode="+selSearchRlsCode+"&selectKeyWords="+selectSearchHot+"";
				return true;
		       }
		     }
		   });
