...
@Controller
@RequestMapping("/back/member/hyqmember")
public class HyqMemberManageController {
	...
	public ModelAndView userList(Page<HyqUserData> pageData, String userInfo) {
		...
		ModelAndView mav = new ModelAndView("/back/member/hyqmember");
	...
	public ModelAndView deleteUser(Long id) throws Exception {
		...
		ModelAndView mav = new ModelAndView("redirect:/back/member/hyqmember/list");
		return mav;
	}
