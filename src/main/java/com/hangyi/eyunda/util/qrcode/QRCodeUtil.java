package com.hangyi.eyunda.util.qrcode;
...
public class QRCodeUtil {
	...
	public static String encode(String content, String imgPath, String destPath, boolean needCompress)
		...
		String pf = destPath + "/" + file;
		ImageIO.write(image, FORMAT_NAME, new File(pf));
		return pf;
	}
	...
	public static void main(String[] args) throws Exception {
		String encodeContent = "http://www.eyd98.com/phone/cyq.apk";
		String pf = QRCodeUtil.encode(encodeContent, "/Users/xuguangzhong/temp/logo.jpg", "/Users/xuguangzhong/temp",
				true);

		String decodeContent = QRCodeUtil.decode(pf);
