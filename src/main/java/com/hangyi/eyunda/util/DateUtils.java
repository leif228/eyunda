...
public class DateUtils {
	...
	/** 两个时间相差距离多少分 */
	public static Long getDistanceMinutes(String str1, String str2, String pattern) {
		if (pattern == null || pattern.equals("")) {
			pattern = "yyyyMMddHHmm";
		}
	...
	public static void main(String args[]) {
		String m = "2014-02-10 14:22:18";
		Date dt = DateUtils.StrToDate(m, "yyyy-MM-dd HH:mm:ss");
		System.out.println("the datetime is " + dt);
	}
}
