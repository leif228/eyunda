...
public class ZjjzApiService {
	...
	private String getTranMessageHead(String hLength, HashMap parmaKeyDict) {
		...
		String tranMessageHead = hTranFunc + hServType + hMacCode + hTrandateTime + hRspCode + hRspMsg + hConFlag
				+ hLength + hCounterId + hThirdLogNo + hQydm;
	...
	private String getTranMessageNetHead(String hLength, HashMap parmaKeyDict) {
		...
		String tranMessageNetHead = netHeadPart1 + hQydm + netHeadPart2 + hLength + hTradeCode + hCounterId + hServType
				+ hTrandateTime + hThirdLogNo + hRspCode + hRspMsg + hConFlag + hTimes + hSignFlag + hSignPacketType
				+ netHeadPart3 + netHeadPart4;
	...
	private String getTranMessageBody_6000(HashMap parmaKeyDict) {
		...
		String tranMessageBody = bFuncFlag + "&" + bSupAcctId + "&" + bThirdCustId + "&" + bCustProperty + "&"
				+ bNickName + "&" + bMobilePhone + "&" + bEmail + "&" + bReserve + "&";
	...
	private String getTranMessageBody_6055(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + CustAcctId + "&" + ThirdCustId + "&" + CustName + "&" + IdType + "&"
				+ IdCode + "&" + AcctId + "&" + BankType + "&" + BankName + "&" + BankCode + "&" + SBankCode + "&"
				+ MobilePhone + "&" + Reserve + "&";
	...
	private String getTranMessageBody_6063(HashMap parmaKeyDict) {
		...
		String tranMessageBody = FuncFlag + "&" + SupAcctId + "&" + CustAcctId + "&" + CustName + "&" + NickName + "&"
				+ IdType + "&" + IdCode + "&" + ThirdCustId + "&" + MobilePhone + "&" + TelePhone + "&" + Email + "&"
				+ Address + "&" + CPFlag + "&" + BankFlag + "&" + AcctName + "&" + AcctId + "&" + BankName + "&"
	...
	private String getTranMessageBody_6064(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + ThirdCustId + "&" + CustAcctId + "&" + AcctId + "&" + TranAmount
				+ "&" + CcyCode + "&" + Reserve + "&";
	...
	private String getTranMessageBody_6067(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + ThirdCustId + "&" + CustAcctId + "&" + AcctId + "&" + MessageCode
				+ "&" + Reserve + "&";
	...
	private String getTranMessageBody_6056(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + CustAcctId + "&" + ThirdCustId + "&" + TranAmount + "&" + CcyCode
				+ "&" + Note + "&" + Reserve + "&";
	...
	private String getTranMessageBody_6033(HashMap parmaKeyDict) {
		...
		String tranMessageBody = TranWebName + "&" + CustAcctId + "&" + IdType + "&" + IdCode + "&" + ThirdCustId + "&"
				+ CustName + "&" + SupAcctId + "&" + OutAcctId + "&" + OutAcctIdName + "&" + CcyCode + "&" + TranAmount
				+ "&" + Note + "&" + Reserve + "&" + WebSign + "&";
	...
	private String getTranMessageBody_6007(HashMap parmaKeyDict) {
		...
		String tranMessageBody = FuncFlag + "&" + SupAcctId + "&" + CustAcctId + "&" + ThirdCustId + "&" + TranAmount
				+ "&" + HandFee + "&" + CcyCode + "&" + ThirdHtId + "&" + ThirdHtMsg + "&" + Note + "&" + Reserve + "&";
	...
	private String getTranMessageBody_6008(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + CustAcctId + "&" + ThirdCustId + "&" + CustName + "&" + TranAmount
				+ "&" + CcyCode + "&" + Reserve + "&";
	...
	private String getTranMessageBody_6031(HashMap parmaKeyDict) {
		...
		String tranMessageBody = FuncFlag + "&" + SupAcctId + "&" + OutCustAcctId + "&" + OutThirdCustId + "&"
				+ OutCustName + "&" + InCustAcctId + "&" + InThirdCustId + "&" + InCustName + "&" + TranAmount + "&"
				+ TranFee + "&" + TranType + "&" + CcyCode + "&" + ThirdHtId + "&" + ThirdHtMsg + "&" + Note + "&"
				+ Reserve + "&";
	...
	private String getTranMessageBody_6034(HashMap parmaKeyDict) {
		...
		String tranMessageBody = FuncFlag + "&" + OutCustAcctId + "&" + SupAcctId + "&" + OutThirdCustId + "&"
				+ OutCustName + "&" + InCustAcctId + "&" + InThirdCustId + "&" + InCustName + "&" + TranAmount + "&"
				+ TranFee + "&" + TranType + "&" + CcyCode + "&" + ThirdHtId + "&" + ThirdHtMsg + "&" + Note + "&"
				+ Reserve + "&" + WebSign + "&";
	...
	private String getTranMessageBody_6050(HashMap parmaKeyDict) {
		...
		String tranMessageBody = FuncFlag + "&" + SupAcctId + "&" + BeginDate + "&" + EndDate + "&" + PageNum + "&"
				+ Reserve + "&";
	...
	private String getTranMessageBody_6072(HashMap parmaKeyDict) {
		...
		String tranMessageBody = FuncFlag + "&" + SupAcctId + "&" + CustAcctId + "&" + SelectFlag + "&" + BeginDate
	...
	private String getTranMessageBody_6065(HashMap parmaKeyDict) {
		...
		String tranMessageBody = FuncFlag + "&" + SupAcctId + "&" + ThirdCustId + "&" + CustAcctId + "&" + AcctId + "&"
				+ Reserve + "&";
	...
	private String getTranMessageBody_6068(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + CustAcctId + "&" + CustName + "&" + IdType + "&" + IdCode + "&"
				+ TranAmount + "&" + ProductCode + "&" + Reserve + "&";
	...
	private String getTranMessageBody_6069(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + CustAcctId + "&" + ClientNo + "&" + TranAmount + "&" + ProductCode
				+ "&" + TradeType + "&" + Reserve + "&";

		return tranMessageBody;
	}

	private String getTranMessageBody_6070(HashMap<String, String> parmaKeyDict) {

		String tranMessageBody = "";

		if (parmaKeyDict.containsKey("SupAcctId"))
			tranMessageBody += (String) parmaKeyDict.get("SupAcctId") + "&";
		else
			tranMessageBody += "&";

		if (parmaKeyDict.containsKey("OutCustAcctId"))
			tranMessageBody += (String) parmaKeyDict.get("OutCustAcctId") + "&";
		else
			tranMessageBody += "&";
		if (parmaKeyDict.containsKey("OutThirdCustId"))
			tranMessageBody += (String) parmaKeyDict.get("OutThirdCustId") + "&";
		else
			tranMessageBody += "&";
		if (parmaKeyDict.containsKey("HandFee"))
			tranMessageBody += (String) parmaKeyDict.get("HandFee") + "&";
		else
			tranMessageBody += "&";
		if (parmaKeyDict.containsKey("CcyCode"))
			tranMessageBody += (String) parmaKeyDict.get("CcyCode") + "&";
		else
			tranMessageBody += "&";
		if (parmaKeyDict.containsKey("ThirdHtId"))
			tranMessageBody += (String) parmaKeyDict.get("ThirdHtId") + "&";
		else
			tranMessageBody += "&";
		if (parmaKeyDict.containsKey("TotalCount"))
			tranMessageBody += (String) parmaKeyDict.get("TotalCount") + "&";
		else
			tranMessageBody += "&";

		String TotalCount = (String) parmaKeyDict.get("TotalCount");
		int count = Integer.parseInt(TotalCount);
		for (int i = 0; i < count; i++) {
			if (parmaKeyDict.containsKey("InCustAcctId" + i))
				tranMessageBody += (String) parmaKeyDict.get("InCustAcctId" + i) + "&";
			else
				tranMessageBody += "&";
			if (parmaKeyDict.containsKey("InThirdCustId" + i))
				tranMessageBody += (String) parmaKeyDict.get("InThirdCustId" + i) + "&";
			else
				tranMessageBody += "&";
			if (parmaKeyDict.containsKey("TranAmount" + i))
				tranMessageBody += (String) parmaKeyDict.get("TranAmount" + i) + "&";
			else
				tranMessageBody += "&";
		}

		if (parmaKeyDict.containsKey("Note"))
			tranMessageBody += (String) parmaKeyDict.get("Note") + "&";
		else
			tranMessageBody += "&";
		if (parmaKeyDict.containsKey("Reserve"))
			tranMessageBody += (String) parmaKeyDict.get("Reserve") + "&";
		else
			tranMessageBody += "&";
	...
	private String getTranMessageBody_6040(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + ProductCode + "&" + BeginDate + "&" + EndDate + "&" + PageNum + "&"
				+ Reserve + "&";
	...
	private String getTranMessageBody_6044(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + CustAcctId + "&" + ClientNo + "&" + ProductCode + "&" + BeginDate
				+ "&" + EndDate + "&" + PageNum + "&" + Reserve + "&";
	...
	private String getTranMessageBody_6089(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + ThirdCustId + "&" + CustAcctId + "&" + CustName + "&" + IdType + "&"
				+ IdCode + "&" + AcctId + "&" + BankType + "&" + BankName + "&" + BankCode + "&" + SBankCode + "&"
				+ Reserve + "&";
	...
	private String getTranMessageBody_6082(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + ThirdCustId + "&" + CustAcctId + "&" + TranType + "&" + TranAmount
				+ "&" + AcctId + "&" + ThirdHtId + "&" + TranNote + "&" + Reserve + "&";
	...
	private String getTranMessageBody_6083(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + ThirdCustId + "&" + CustAcctId + "&" + ModifiedType + "&"
				+ NewMobilePhone + "&" + AcctId + "&" + Reserve + "&";
	...
	private String getTranMessageBody_6084(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + ThirdCustId + "&" + CustAcctId + "&" + ModifiedType + "&" + SerialNo
				+ "&" + MessageCode + "&" + Reserve + "&";
	...
	private String getTranMessageBody_6085(HashMap parmaKeyDict) {
		...
		String tranMessageBody = SupAcctId + "&" + CustAcctId + "&" + ThirdCustId + "&" + CustName + "&" + OutAcctId
				+ "&" + OutAcctIdName + "&" + CcyCode + "&" + TranAmount + "&" + HandFee + "&" + SerialNo + "&"
				+ MessageCode + "&" + Note + "&" + Reserve + "&" + WebSign + "&";
