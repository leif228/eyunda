...
public class DemoAPI004 {
	public static void main(String[] args) throws Exception {
		...
		input.put("customerId", "163269280");
		...
		try {
			strResult = new String(PapayHttpProtocolHandler.sendData(nameValuePair,
					"https://testebank.sdb.com.cn/khpayment/API004.do", null, null), "UTF-8");
			// strResult = new
			// String(PapayHttpProtocolHandler.sendData(nameValuePair,
			// "http://localhost:8080/khpayment/API004.do", null,
			// null),"UTF-8");
