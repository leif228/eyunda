	...
	public static void main(String[] args) throws Exception {
		...
		try {
			strResult = new String(PapayHttpProtocolHandler.sendData(nameValuePair,
					"https://testebank.sdb.com.cn:461/khpayment/API006.do", null, null), "UTF-8");
			// strResult = new
			// String(PapayHttpProtocolHandler.sendData(nameValuePair,
			// "http://localhost:8080/khpayment/API006.do", null,
			// null),"UTF-8");
			...
			String dateTime = (String) output.getDataValue("dateTime");
