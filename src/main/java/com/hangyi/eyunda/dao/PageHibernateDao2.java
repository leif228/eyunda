...
public class PageHibernateDao2<T, PK extends Serializable> {
	...
	public SessionFactory getSessionFactory2() {
		return ((this.sessionFactory2 != null) ? this.sessionFactory2 : null);
	}

	public Session getSession() {
		return this.sessionFactory2.getCurrentSession();
	}
	...
	public String getIdName() {
		ClassMetadata meta = getSessionFactory2().getClassMetadata(entityClass);
