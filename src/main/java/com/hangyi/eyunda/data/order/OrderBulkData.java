...
public class OrderBulkData extends OrderCommonData {
	...
	private BulkTypeCode bulkType = null; // 货类
	...
	public BulkTypeCode getBulkType() {
		return bulkType;
	}

	public void setBulkType(BulkTypeCode bulkType) {
